...
average_time = {'polytope_vo': 0, 'polytope_rvo': 0, 'polytope_hrvo': 0, 'circle_vo': 0, 'circle_rvo': 0, 'circle_hrvo': 0}
common_travel_distance = {'polytope_vo': [], 'polytope_rvo': [], 'polytope_hrvo': [], 'circle_vo': [], 'circle_rvo': [], 'circle_hrvo': []}
mean_travel_distance = {'polytope_vo': [], 'polytope_rvo': [], 'polytope_hrvo': [], 'circle_vo': [], 'circle_rvo': [], 'circle_hrvo': []}
std_travel_distance = {'polytope_vo': [], 'polytope_rvo': [], 'polytope_hrvo': [], 'circle_vo': [], 'circle_rvo': [], 'circle_hrvo': []}

file_name = 'travel_time.json'
...
file_name = 'travel_distance.json'
with open(file_name) as f:
