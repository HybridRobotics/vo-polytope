...
# root_path = '/home/hjh/PycharmProjects/Polytope_Multi_Agent'
...
approaches = ['polytope_vo', 'circle_vo']
...
# file_path = Path(__file__).parent / 'data_analysis'
# if file_path.exists():
#     pass
# else:
#     file_path.mkdir()
    ...
    for approach in approaches:
        ...
        if env.all_stop_polygon():
            if env.all_arrive_polygon():
                ...
                travel_time[approach].append(time_sum)  # only success then add
