...
class reciprocal_vel_obs:
    ...
    def cal_vel(
        ...
        agent_state, ns_list, oc_list, ol_list = self.preprocess(
            agent_state, nei_state_list, obs_cir_list, obs_line_list
        )
        ...
        rvo_vel = self.vel_select(
            agent_state, vo_outside, vo_inside, ns_list, oc_list, ol_list, vo_list
        )
    ...
    def config_vo_line(self, agent_state, line):
    ...
    def penalty(
        ...
        for moving in nei_state_list:
            ...
            tc = self.cal_exp_tim(
                rel_x, rel_y, rel_vx, rel_vy, agent_state[4] + moving[4]
            )
