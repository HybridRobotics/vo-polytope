...
from vo_polytope.world import motion_diff, motion_omni, lidar2d
from collections import namedtuple
from vo_polytope.util import collision_polygon_polygon, collision_polygon_circle, collision_seg_matrix, collision_seg_seg
...
class Polygon_Robot:
    ...
    def get_center_point(self):
        ...
        self.state = np.array([center_x, center_y, center_theta], ndmin=2).T
